	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<p>Cacharreando con la tecnología pronto vimos tracción en el proyecto. Empezamos a recibir visitas en la página web y las peticiones de los usuarios nos hicieron evolucionar el proyecto hacia algo más formal. Primero vino el buscador público, luego el sistema de alertas por subscripción, las invitaciones, y por último nuestra apuesta por el SEO. Pasamos rápidamente de 18 boletines oficiales a los 65 actuales y las visitas se dispararon.</p>
				<p>Nunca pensamos que este proyecto sería rentable, pero comprendimos que debíamos buscar un modelo de negocio para poder mantenerlo. Los costes empezaban a hacer mella en el proyecto, así que decidimos experiementar. Por ejemplo, durante varios meses intentamos monetizar las visitas con publicidad. La experiencia de usuario empeoró, así que dicidimos buscar un modelo más acorde con nuestra tecnología y los costes asociados a la misma. Tras varias iteraciones sobre precios, el modelo actual de pago por alerta se impuso como el más cómodo y fiable para nuestros usuarios.</p>
