		...
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					...
					<p>El 90% de las búsquedas se resuelven en menos de 50 milisegundos.</p>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-4">
					...
					<p>Busca en todos os boletines oficiales desde un único lugar.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>Nuestra tecnología es la más rápida y potente del mercado. Cada día recorremos
					las páginas web de los diferentes organismos oficiales
					para descargar y analizar las nuevas publicaciones. Una vez analizadas las publicaciones, el
					contenido es
