	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<p>Las alertas tienen un coste de 15€/mes las 5 primeras alertas. 12€/mes hasta 20 alertas y 8€/mes
					para más de 20 alertas. Si necesitas un volumen mayor de alertas, <a href="{{ route('contact') }}">
						contacta con nosotros</a>.</p>
				<a href="{{ route('alerts.create', Request::query()) }}" class="btn btn-primary">Registrarse y crear una alerta</a>
			</div>
		</div>
	</div>
@endsection
