...
@section('seo')
    <title>Infoboe, busca en los boletines oficiales del estado</title>
    <meta name="description" content="Infoboe te permita buscar en todos los boletines oficiales del Estado y crear alertas para estar siempre informado.">
@endsection
